    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-10 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 flex flex-col">
          {kbError && <KnowledgeBaseError message={kbError} />}
...
/* ------------------------------------------------------------------ */
function KnowledgeBaseError({ message }: { message: string }) {
  return (
    <div className="mb-8 py-10 hairline-top hairline-bottom">
    ...
    <div className="text-sm">
      ...
      {!lastWithSources ? (
        <p className="text-ink-faint text-xs">
          Sources cited by ResearchTwin-K.Lu will appear here once you send a message.
        </p>
      ) : (
